    ...
    <footer>
       <section className="mx-auto">
          <div className="bg-[#242424]">
            <div className="flex flex-wrap px-2 py-12 mb-5 xl:flex-nowrap md:px-5 md:xl-10">
                     ...
                     <div className="w-full mb-5 xl:mb-px xl:w-1/4">
                      ...
                      <div className="flex flex-wrap justify-between w-full xl:w-2/4 lg:w-4/5 xl:flex-nowrap">
                        <div className="w-1/2 mb-5 md:w-1/4">
                          <ul className="text-[#F2F2F2]">
                            <li className="mb-5 text-2xl font-semibold">О нас</li>
            ...
            <div className="flex items-center px-2 pb-12 md:px-5 lg:px-10">
                <div className="flex w-1/2 gap-2">
                 ...
                 <div className="items-center justify-between block w-1/2 ml-5 lg:ml-px lg:flex">
                    <div>
